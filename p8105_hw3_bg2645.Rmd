...
* There were `r nrow(accel_data)` observations and `r ncol(accel_data)` variables in the `accel_data` dataset. 
* The key variables in the `accel_data` dataset was the week, day id, day, activity in minutes, activity count, and variables determining whether the day was a weekday or not. 
